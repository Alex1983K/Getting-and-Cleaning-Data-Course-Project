...
Tidy data set has 180 rows and 69 columns. Below is the list of variables for the data set, followed by the summary created with 'str' function:
...
'data.frame':   180 obs. of  69 variables:
 ...
 $ Activity_Description       : chr  "WALKING" "WALKING_UPSTAIRS" "WALKING_DOWNSTAIRS" "SITTING" ...
