...
## Following changes have been performed on the data set:

1. Training and test sets were merged to create one data set.
2. Mean and standard deviation data for each measurement were extracted.
3. Descriptive activity names were used to name the activities in the data set.
4. Data set was appropriately labelled with descriptive variable names.
